...
// 部署自定义业务流程实例
export function startByDataId(dataId,selectFlowId, serviceName, data) {
  return request({
    url: '/workflow/process/startByDataId/' + dataId + '/' + selectFlowId + '/'+ serviceName,
    method: 'post',
    data: data
  })
}
...
export function getProcesss(query) {
  return request({
    url: '/workflow/process/getProcesss',
    method: 'get',
    params: query
  })
}
